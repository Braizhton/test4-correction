...
And I authenticated as "jvaljean" using "mdp1234"
When I submit the form
Then I should see Accueil
When I click on Mon Compte
Then I should see Mon Compte form
When I put nom as "test", prenom as "test", birthday as "01/01/2000", phone as "0600000001", email as "user@domain.mail", login as "", password as "mdp1234", password2 as "mdp1234", number as "8", street as "Somewhere", districtCode as "49100", city as "Nowhere"
